...
class TestUtils {
     ...
     * CHECKPOINT
     */
    static final HashMap<String, String> CHECKPOINT  = new HashMap<>();
    static {
        CHECKPOINT.put("I", "(WORDLE) (IS) (FUN)");
        CHECKPOINT.put("II", "(TEARS) (BOING) (LUCKY)");
        CHECKPOINT.put("III", "(QUACK) (FROZE) (TWINS) (GLYPH)");
        CHECKPOINT.put("B", "(AZ) (BY) (CX) (DW) (EV) (FU) (GT) "
                + "(HS) (IR) (JQ) (KP) (LO) (MN)");
    }
}
